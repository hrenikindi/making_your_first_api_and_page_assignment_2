...
// A map of HTTP status codes and their descriptions
const statusCodes = {
...
app.get('/status-info', (req, res) => {
    const code = parseInt(req.query.code); // Parse the code from query parameters

    // Validate the status code and respond accordingly
    ...
    // Send the response with the status code and its description
    res.json({
        status: code,
